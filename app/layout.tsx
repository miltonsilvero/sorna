        ...
        <ThemeProvider attribute="class" defaultTheme="light" enableSystem>
          ...
          <footer className="py-8 flex items-center justify-between">
            ...
            <div className="flex space-x-4">
              <Link href="mailto:atilasilvero@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email">
              ...
              <Link href="https://twitter.com/miltonsilvero" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
              ...
              <Link href="https://instagram.com/milton.silvero" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200" fill="currentColor" viewBox="0 0 24 24">
